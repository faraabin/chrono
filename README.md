...
## مستندات
- در فولدر doc/html راهنمای API های ماژول کرونو به فرمت html ارائه شده است.
- در ابتدای فایل c راهنمای کامل نحوه استفاده از ماژول کرونو نوشته شده است.
- در فولدر example مثال هایی برای استفاده از ماژول کرونو در مخزن جداگانه ای به نام chrono-example موجود است.
- در فولدر doc مقاله ای در مورد مبانی اندازه گیری زمان در نرم افزار نهفته موجود است. 
## الزامات
