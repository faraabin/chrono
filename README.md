...
## مثال ها
در مخزن، فولدری به نام example وجود دارد. در این فولدر مثال هایی در محیط Keil IDE و بر روی بورد Nucleo-L432KC تعریف شده است که استفاده از قابلیت های مختلف ماژول کرونو در آن نشان داده شده است.
- مثال 1 : در این مثال، تیک سخت افزاری با استفاده از یک تایمر 32 بیتی ایجاد شده است و به صورت یک متغیر به ماژول کرونو معرفی شده است.
- مثال 2 : در این مثال، تیک سخت افزاری با استفاده از یک تایمر 16 بیتی و اینتراپت سرریز آن، و در قالب یک تابع به ماژول کرونو معرفی شده است.
## مستندات
- در فولدر doc راهنمای API های ماژول کرونو ارائه شده است.
- در ابتدای فایل c راهنمای کامل نحوه استفاده از ماژول کرونو نوشته شده است.
- در فولدر example مثال هایی برای استفاده از ماژول کرونو موجود است.
- در ؟؟؟ مطلبی در مورد مبانی اندازه گیری زمان در نرم افزار نهفته موجود است. 
## الزامات
