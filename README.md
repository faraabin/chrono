...
> در اکثر موارد تیک توسط یک تایمر سخت افزاری ایجاد میشود. مثلا در صورتی که تیک یک میکروثانیه بخواهیم، باید یکی از تایمرهای 32 بیتی یا 16 بیتی میکرو را با کلاک 1 مگاهرتز راه اندازی کرده و آدرس رجیستر شمارنده آن را به تابع راه اندازی کرونو بدهیم.
