...
# ماژول کرونو
ماژول کرونو برای [اندازه گیری زمان در نرم افزار نهفته](https://github.com/faraabin/chrono/wiki/%D8%A7%D9%86%D8%AF%D8%A7%D8%B2%D9%87-%DA%AF%DB%8C%D8%B1%DB%8C-%D8%B2%D9%85%D8%A7%D9%86-%D8%AF%D8%B1-%D9%86%D8%B1%D9%85-%D8%A7%D9%81%D8%B2%D8%A7%D8%B1-%D9%86%D9%87%D9%81%D8%AA%D9%87) است. این ماژول با استفاده از یک تیک سخت افزاری یا نرم افزاری، تمام توابع پایه لازم برای اندازه گیری زمان را در اختیار کاربر قرار می دهد.
## اندازه گیری زمان در نرم افزار نهفته
از آنجایی که یکی از بارزترین ویژگی های نرم افزار نهفته، اجرای کد در زمان بندی های مشخص است، [اندازه گیری زمان در نرم افزار نهفته](https://github.com/faraabin/chrono/wiki/%D8%A7%D9%86%D8%AF%D8%A7%D8%B2%D9%87-%DA%AF%DB%8C%D8%B1%DB%8C-%D8%B2%D9%85%D8%A7%D9%86-%D8%AF%D8%B1-%D9%86%D8%B1%D9%85-%D8%A7%D9%81%D8%B2%D8%A7%D8%B1-%D9%86%D9%87%D9%81%D8%AA%D9%87) اهمیت ویژه ای دارد.
...
- تیک لازم را در پروژه ایجاد کنید. (این تیک میتواند به صورت سخت افزاری و بوسیله یک تایمر و یا به صورت نرم افزاری ایجاد شود. توضیحات بیشتر در این مورد در مقاله [اندازه گیری زمان در نرم افزار نهفته](https://github.com/faraabin/chrono/wiki/%D8%A7%D9%86%D8%AF%D8%A7%D8%B2%D9%87-%DA%AF%DB%8C%D8%B1%DB%8C-%D8%B2%D9%85%D8%A7%D9%86-%D8%AF%D8%B1-%D9%86%D8%B1%D9%85-%D8%A7%D9%81%D8%B2%D8%A7%D8%B1-%D9%86%D9%87%D9%81%D8%AA%D9%87) ارایه شده است.)
> در اکثر موارد تیک توسط یک تایمر سخت افزاری ایجاد میشود. مثلا در صورتی که تیک یک میکروثانیه بخواهیم، باید یکی از تایمرهای 32 بیتی یا 16 بیتی میکروکنترلر را با کلاک 1 مگاهرتز راه اندازی کرده و آدرس رجیستر شمارنده آن را به تابع راه اندازی کرونو بدهیم.
- با فراخوانی تابع 'fChrono_Init' ماژول کرونو را راه اندازی کنید. به ورودی این تابع باید اشاره گر به متغیر یا تابع تیک باید داده شود.
...
- باید مشخص شود که مقدار تیک بالارونده است یا پایین رونده
- حداکثر مقدار تیک باید مشخص شود
- زمان هر تیک بر حسب نانوثانیه باید مشخص شود.
...
## شروع استفاده
برای شروع استفاده میتوانید به مطلب [شروع کنید](https://github.com/faraabin/chrono/wiki/%D8%B4%D8%B1%D9%88%D8%B9-%DA%A9%D9%86%DB%8C%D8%AF) مراجعه کنید. 
...
- مثال هایی برای استفاده از ماژول کرونو در مخزن جداگانه ای به نام [example_chrono](https://github.com/faraabin/chrono-example) موجود است.
- در بخش [wiki](https://github.com/faraabin/chrono/wiki) مستندات بیشتری در مورد ماژول کرونو موجود است. 
## الزامات
